...
export async function action({ request, params }) {
  ...
  try {
    ...
    if (normalizedStatus === "APPROVED") createData.approvedAt = new Date();
    ...
    if (normalizedStatus === "APPROVED") updateData.approvedAt = new Date();
    ...
    const message = error?.message || "Failed to update report";
