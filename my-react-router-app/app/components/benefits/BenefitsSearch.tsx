      ...
      <div className="relative flex flex-col md:flex-row gap-3 sm:gap-6">
        ...
        <div className="relative md:w-72 group/select">
          ...
          <select
            ...
            className="appearance-none w-full pl-10 sm:pl-12 pr-12 py-3 sm:py-4 rounded-xl sm:rounded-2xl bg-background/50 dark:bg-card/40 border border-border/50 dark:border-white/5 text-foreground text-sm font-bold focus:outline-none focus:border-iu-blue/50 dark:focus:border-iu-blue/50 cursor-pointer transition-all hover:bg-muted/50 dark:hover:bg-white/5 shadow-sm"
          >
