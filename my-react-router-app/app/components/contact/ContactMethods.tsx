  ...
  return (
    <div className={`group p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-border hover:border-iu-blue/30 hover:bg-card hover:shadow-2xl transition-all duration-500 ${isSpecial ? "bg-iu-blue/5 border-iu-blue/10" : "bg-background/50"}`}>
      <div className="flex items-center gap-3 mb-2 sm:mb-3">
        <div className="p-1.5 sm:p-2 rounded-lg sm:rounded-xl bg-iu-blue/10 text-iu-blue group-hover:scale-110 transition-transform">
          {icon}
        </div>
      ...
      <a
        href={href}
        className="text-base sm:text-lg font-bold text-foreground group-hover:text-iu-blue transition-colors break-all leading-tight block"
      >
        {value}
      </a>
    </div>
