...
export function EmergencyContact({ t }: EmergencyContactProps) {
  return (
    <div className="bg-iu-red/5 border border-iu-red/20 sm:rounded-[2.5rem] rounded-2xl p-6 sm:p-8 shadow-xl relative overflow-hidden group hover:bg-iu-red/10 transition-all duration-500">
      <div className="flex items-center gap-3 mb-4 sm:mb-6">
        <div className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-iu-red/10 text-iu-red shadow-sm border border-iu-red/20 shrink-0">
      ...
      <div className="bg-card/80 backdrop-blur-md border border-iu-red/20 rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-xl">
        ...
        <a
          ...
          className="text-lg sm:text-2xl font-bold text-iu-red hover:text-iu-red/80 transition-all flex items-center gap-2 sm:gap-3 break-all"
        >
