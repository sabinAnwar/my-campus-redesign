export const LoginHeader = () => (
  <div className="mb-12 text-center">
    ...
    <p className="text-slate-700 dark:text-slate-200 text-sm sm:text-base font-semibold mb-2">IU Dual Degree Platform</p>
    <p className="text-slate-700 dark:text-slate-200 text-sm font-medium">Manage marks, applications & modules in one place</p>
  </div>
);
