...
export const NAVIGATION_CARDS: NavigationCard[] = [
  {
    ...
    iconBg: "bg-iu-blue/10 border border-iu-blue/30 dark:bg-iu-blue/30 dark:border-iu-blue/60",
  ...
  },
  {
    ...
    iconBg: "bg-blue-100 border border-blue-300 dark:bg-blue-900/40 dark:border-blue-700",
  ...
  },
  {
    ...
    iconBg: "bg-violet-100 border border-violet-300 dark:bg-violet-900/40 dark:border-violet-700",
    iconColor: "text-violet-900 dark:text-violet-100",
  ...
  },
  {
    ...
    iconBg: "bg-amber-100 border border-amber-300 dark:bg-amber-900/40 dark:border-amber-700",
