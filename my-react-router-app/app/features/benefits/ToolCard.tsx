...
export function ToolCard({ t, tool }: ToolCardProps) {
  return (
    <article className="group relative rounded-[2rem] sm:rounded-[2.5rem] p-4 sm:p-8 bg-card/40 dark:bg-card/30 border border-border/50 dark:border-white/5 shadow-xl hover:border-iu-blue/30 dark:hover:border-iu-blue/50 hover:bg-card dark:hover:bg-card/50 hover:shadow-2xl hover:shadow-iu-blue/5 transition-all duration-500 backdrop-blur-xl overflow-hidden group/card flex flex-col sm:flex-row gap-4 sm:gap-8 items-start sm:items-center">
