...
import { categoryBadge } from "~/config/benefits";
    ...
    <div className="space-y-4 sm:space-y-6 md:space-y-8">
      <div className="flex items-center gap-3 sm:gap-4 md:gap-5">
        ...
        <div>
          ...
          <p className="text-[9px] sm:text-[10px] md:text-xs text-foreground dark:text-white font-black uppercase tracking-widest sm:tracking-[0.2em] mt-0.5 sm:mt-1">
