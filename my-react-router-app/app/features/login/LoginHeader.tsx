export const LoginHeader = () => (
  <div className="mb-4 lg:mb-5 text-center">
    <div className="mb-3 lg:mb-4 flex justify-center lg:hidden">
      <div className="relative h-12 w-12 sm:h-16 sm:w-16 bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl flex items-center justify-center shadow-lg">
        <span className="text-white font-black text-xl sm:text-2xl">IU</span>
      </div>
    </div>
