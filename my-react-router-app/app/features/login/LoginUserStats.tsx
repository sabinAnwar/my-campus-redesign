export const LoginUserStats = ({ total, online }: { total: number; online: number }) => (
  <div className="mt-8 text-center">
    <div className="inline-block">
      <p className="text-3xl sm:text-5xl font-black text-white drop-shadow-lg">{total}+</p>
      <p className="text-xs text-white font-semibold mt-2 uppercase tracking-wider">Active Dual Degree Students</p>
