  ...
  return (
    ...
    >
      <div className="relative z-10 flex items-start justify-between gap-3 sm:gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-[10px] uppercase tracking-[0.3em] text-muted-foreground dark:text-slate-200 font-bold">
              {selectedLocation}
            </p>
          </div>
        ...
        <div
          className={`px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl text-[8px] sm:text-[9px] md:text-[10px] font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] border flex items-center gap-1.5 sm:gap-2 ${
            occupied
              ? "bg-orange-500/10 text-orange-500 border-orange-500/20 dark:bg-orange-500 dark:text-white dark:border-orange-500/60"
      ...
      <div className="relative z-10">
        {lecture ? (
          <div className="bg-muted/50 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-orange-500/10 dark:border-orange-500/40">
            ...
            <p className="text-[9px] sm:text-[10px] text-muted-foreground dark:text-slate-200 mt-1">
      ...
      <div className="relative z-10 mt-auto">
        {status === "gebucht" && booking ? (
          <button
            ...
            disabled={isLoading}
            className="w-full inline-flex justify-center items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl bg-orange-500/10 hover:bg-orange-500 text-orange-500 hover:text-white dark:bg-orange-500 dark:text-white dark:border-orange-500/60 font-bold px-4 sm:px-6 py-3 sm:py-4 transition-all uppercase tracking-widest text-[9px] sm:text-[10px] border border-orange-500/20"
          >
          ...
          <button
            ...
            className={`w-full inline-flex justify-center items-center gap-1.5 sm:gap-2 rounded-lg sm:rounded-xl font-bold px-4 sm:px-6 py-3 sm:py-4 transition-all uppercase tracking-widest text-[9px] sm:text-[10px] ${
              occupied
                ? "bg-muted text-muted-foreground dark:text-slate-200 cursor-not-allowed"
