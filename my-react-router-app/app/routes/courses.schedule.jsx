        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold bg-white border border-slate-300 hover:border-slate-400 shadow-sm hover:shadow-md transition"
              >
          ...
          {expandedStats && (
            <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="text-xs text-slate-600 mt-2">optional</div>
              </div>
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                <div className="text-xs font-bold text-slate-500 uppercase tracking-wide mb-2">
                  Most Common Type
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="text-xs text-slate-600 mt-2">saved events</div>
              </div>
            </div>
          )}
                    ...
                    {types.map((t) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <span>{t}</span>
                          {t !== "All" && (
                            <span className="text-xs bg-slate-300 text-slate-900 px-2 py-0.5 rounded">
                              {typeCounts[t] || 0}
                            </span>
                          )}
                        </div>
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl bg-white border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
                ...
                <div className="grid grid-cols-7 gap-px bg-slate-200 p-2 sm:p-6 rounded-b-xl">
                  {days.map((d, idx) => {
                    ...
                    return (
                      <div
                        key={idx}
                        className={`relative min-h-24 bg-white rounded-lg p-3 cursor-pointer transition hover:shadow-md hover:border-blue-200 border-2 ${
                          isToday
          ...
          {selectedEvent && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              />
              <div className="relative bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-2xl overflow-hidden">
                ...
                {/* Modal Content */}
                <div className="px-6 py-6 space-y-4 text-slate-700">
                ...
                <div className="px-6 pb-6 flex flex-wrap gap-2 border-t border-slate-200 pt-6">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold border border-slate-300 hover:border-slate-400 hover:bg-slate-50 transition"
                  >
