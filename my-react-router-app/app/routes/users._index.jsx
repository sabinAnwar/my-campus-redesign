      ...
      <div className="container mx-auto px-4 py-8">
        {databaseError && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6">
            ...
            <p className="mt-2">Using fallback data. Check your database connection.</p>
          </div>
        )}
        ...
        {users.length === 0 ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
            <div className="mx-auto w-24 h-24 rounded-full flex items-center justify-center mb-6" style={{background: 'linear-gradient(135deg, #6366f1, #9333ea)'}}>
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              Get started by creating your first user. You can add team members, administrators, or regular users to your application.
            </p>
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-500">
                <p>�� Tip: You can create different types of users with various roles.</p>
              </div>
            </div>
          </div>
        ) : (
                ...
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl p-6 border border-gray-100 group-hover:border-indigo-300 transition-all duration-200">
                  <div className="flex items-center space-x-4 mb-4">
                    {user.avatar ? (
                      ...
                      <div className="w-16 h-16 rounded-full flex items-center justify-center ring-4 ring-gray-100 group-hover:ring-indigo-200 transition-all duration-200" style={{background: 'linear-gradient(135deg, #6366f1, #9333ea)'}}>
