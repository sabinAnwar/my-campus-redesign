export const TRANSLATIONS = {
  de: {
    ...
    portal: "Bibliothek / Plattformen",
    faqTitle: "Häufige Fragen",
    faqDesc: "Viele Antworten findest du direkt im FAQ-Bereich.",
    toFaq: "Zum FAQ",
    campusLocations: "Campus-Standorte",
  },
  en: {
    ...
    portal: "Library / platforms",
    faqTitle: "Frequently Asked Questions",
    faqDesc: "You can find many answers directly in the FAQ area.",
    toFaq: "To FAQ",
