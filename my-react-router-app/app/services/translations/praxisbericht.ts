export const TRANSLATIONS = {
  de: {
    ...
    semester: "Semester",
    legend: "Legende",
    mustSubmitLegend: "Praxiswoche – Bericht einreichen",
    draftLegend: "Entwurf",
    submittedLegend: "Eingereicht (grün)",
    reviewedLegend: "Geprüft (Prüfungsamt)",
    klausurphaseLegend: "Klausurphase",
    theorieLegend: "Theorie / kein Praxisbericht nötig",
    nachpruefungLegend: "Nachprüfungsphase",
    feiertagLegend: "Feiertag",
  ...
  en: {
    ...
    semester: "Semester",
    legend: "Legend",
    mustSubmitLegend: "Practice week – report due",
    draftLegend: "Draft",
    submittedLegend: "Submitted (green)",
    reviewedLegend: "Reviewed (Exam Office)",
    klausurphaseLegend: "Exam Phase",
    theorieLegend: "Theory / no report needed",
    nachpruefungLegend: "Resit Exam Phase",
    feiertagLegend: "Public Holiday",
