export const TRANSLATIONS = {
  de: {
    ...
    types: {
      ...
      Portfolio: "Portfolio",
      Fachpräsentation: "Fachpräsentation",
      "Wissenschaftliche Arbeit": "Wissenschaftliche Arbeit",
    },
    titles: {
      "Hausarbeit: Customer Journey im Omnichannel Commerce": "Hausarbeit: Customer Journey im Omnichannel Commerce",
      "Projektarbeit: Commerce Plattform Redesign": "Projektarbeit: Commerce Plattform Redesign",
      "Online-Klausur: E-Commerce Grundlagen": "Online-Klausur: E-Commerce Grundlagen",
      "Klausur: Wirtschaftsinformatik II": "Klausur: Wirtschaftsinformatik II",
    },
    courses: {
  ...
  en: {
    ...
    types: {
      ...
      Portfolio: "Portfolio",
      Fachpräsentation: "Technical Presentation",
      "Wissenschaftliche Arbeit": "Academic Paper",
    },
    titles: {
      "Hausarbeit: Customer Journey im Omnichannel Commerce": "Term Paper: Customer Journey in Omnichannel Commerce",
      "Projektarbeit: Commerce Plattform Redesign": "Project Work: Commerce Platform Redesign",
      "Online-Klausur: E-Commerce Grundlagen": "Online Exam: E-Commerce Foundations",
      "Klausur: Wirtschaftsinformatik II": "Exam: Business Informatics II",
    },
    courses: {
      "E-Commerce": "E-Commerce",
      "Commerce Engineering": "Commerce Engineering",
